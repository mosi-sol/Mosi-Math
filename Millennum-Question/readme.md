...
- I want to spending time for first rows, because thats like [collatz conjector root/reverse](https://github.com/mosi-sol/Mosi-Math/tree/main/3n%2B1(collatz%20conjecture)). I try to finding the leaf of each number (using my reverse code).
